...
function add_expiration_setting_args( $settings ) {
	...
	$setup  = array(
		...
		array(
			'title'    => __( 'Tiempo de expiración', 'woo-cart-expiration' ),
			'desc'     => __( 'Asegúrese de establecer una cantidad de tiempo razonable para permitir que sus visitantes continúen comprando.', 'woo-cart-expiration' ),
